export const smsTemplates = {
  orderConfirmed: (orderNumber: string, total: number) =>
    `BINDU PREMIUM: Your order ${orderNumber} is confirmed! Total: ৳${total}. Track: bindupremium.com.bd/track`,
  orderShipped: (orderNumber: string, tracking: string) =>
    `BINDU PREMIUM: Order ${orderNumber} shipped! Tracking: ${tracking}`,
  orderDelivered: (orderNumber: string) =>
    `BINDU PREMIUM: Order ${orderNumber} delivered! Hope you love it. Review: bindupremium.com.bd`,
  orderCancelled: (orderNumber: string) =>
    `BINDU PREMIUM: Order ${orderNumber} cancelled. Questions? bindupremium.com.bd/contact`,
}
